...
class AccountController extends AbstractController
{
    ...
    // #[Route('/account/password/confirm', name: 'confirm_password')]
    // public function confirmPassword(AddressRepository $addressRepository, Request $request): Response
    // {
    //     $form = $this->createForm(SearchProductType::class, null);
    //     $form->handleRequest($request);
    ...
    //                 $color = "all";
    //             }
    //             return $this->redirect($this->generateUrl('app_search_result', array('name' => $name, 'categorie' => $categorie, 'gender' => $gender, 'color' => $color)));
    //         }
    //     }
    ...
    //     ]);
    // }
    // #[Route('/account/password/edit', name: 'edit_password')]
    ...
    //         }else{
    //             $this->addFlash('error', 'The two passwords are not identical');
    //         }
    //         // return $this->redirectToRoute('confirm_profile');
    //     }
    ...
    // #[Route('/account/profile/confirm', name: 'confirm_password')]
    // public function confirmProfile(AddressRepository $addressRepository): Response
    // {

    //     return $this->render('account/confirmProfile.html.twig');
    // }
