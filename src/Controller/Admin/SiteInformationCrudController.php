...
class SiteInformationCrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            TextField::new('categoryOne'),
            TextField::new('categoryLinkOne'),
            TextField::new('categoryTwo'),
            TextField::new('categoryLinkTwo'),
            TextField::new('categoryThree'),
            TextField::new('categoryLinkThree'),
            TextField::new('categoryFour'),
            TextField::new('categoryLinkFour'),
            TextField::new('categoryFive'),
            TextField::new('categoryLinkFive'),
