 ...
 */
final class Version20240617182001 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP is_rgpd, DROP validation_token, DROP is_valid');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD is_rgpd TINYINT(1) NOT NULL, ADD validation_token VARCHAR(255) DEFAULT NULL, ADD is_valid TINYINT(1) NOT NULL');
    }
}
