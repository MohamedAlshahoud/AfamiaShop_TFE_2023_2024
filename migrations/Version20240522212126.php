 ...
 */
final class Version20240522212126 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD categories_id INT DEFAULT NULL, ADD genders_id INT DEFAULT NULL, ADD colors_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product DROP categories_id, DROP genders_id, DROP colors_id');
    }
}
