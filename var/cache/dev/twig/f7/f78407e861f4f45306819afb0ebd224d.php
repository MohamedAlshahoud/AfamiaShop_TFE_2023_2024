...
class __TwigTemplate_a40fc3a518f1454aa204a2a7a130374f extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        yield "Afamia | ";
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("New Contact", [], "messages");
...
{% block title %}Afamia | {% trans %}New Contact{% endtrans %}{% endblock %}

{% block body %}
{{ include('contact/_form.html.twig') }}

{% endblock %}
", "contact/index.html.twig", "/Users/modeste/Documents/Projets/Fiveer/AFAMIA_SHOP/templates/contact/index.html.twig");
    }
}
