...
class __TwigTemplate_211983eb0ae02d0576d95f5613b1744d extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 37
        yield "                                </div>
                                <a href=\"#carouselExampleControls\" role=\"button\" data-bs-slide=\"prev\" class=\"carousel-control-prev\"><i  class=\"ion-chevron-left\"></i></a>
                                <a href=\"#carouselExampleControls\" role=\"button\" data-bs-slide=\"next\" class=\"carousel-control-next\"><i  class=\"ion-chevron-right\"></i></a>
                            </div>
                        </div>
                    </div>
                    <div  class=\"col-12\">
        ...
        // line 51
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["categories"]) || array_key_exists("categories", $context) ? $context["categories"] : (function () { throw new RuntimeError('Variable "categories" does not exist.', 51, $this->source); })()));
        $context['loop'] = [
          'parent' => $context['_parent'],
          'index0' => 0,
          'index'  => 1,
        ...
        // line 68
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["newProduct"]) || array_key_exists("newProduct", $context) ? $context["newProduct"] : (function () { throw new RuntimeError('Variable "newProduct" does not exist.', 68, $this->source); })()));
        $context['loop'] = [
          'parent' => $context['_parent'],
          'index0' => 0,
          'index'  => 1,
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
            yield " 
                                        ";
            // line 69
            yield from             $this->loadTemplate("product/display_product.html.twig", "home/index.html.twig", 69)->unwrap()->yield($context);
            // line 70
            yield "                                    ";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
...
";
    ...
    {
        return array (  288 => 75,  268 => 70,  266 => 69,  247 => 68,  239 => 63,  229 => 58,  222 => 53,  206 => 52,  187 => 51,  178 => 45,  168 => 37,  145 => 28,  138 => 24,  129 => 18,  125 => 17,  120 => 16,  103 => 15,  92 => 6,  82 => 5,  60 => 3,  37 => 1,);
    }
...
{% endblock %}", "home/index.html.twig", "/Users/modeste/Documents/Projets/Fiveer/AFAMIA_SHOP/templates/home/index.html.twig");
    }
}
