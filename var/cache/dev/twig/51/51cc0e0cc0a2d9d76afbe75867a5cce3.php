...
";
    ...
    {
        return array (  191 => 47,  186 => 46,  181 => 44,  173 => 41,  168 => 39,  164 => 38,  159 => 36,  154 => 34,  148 => 31,  142 => 28,  138 => 27,  135 => 26,  123 => 23,  120 => 22,  118 => 21,  115 => 20,  109 => 18,  107 => 17,  101 => 14,  91 => 6,  81 => 5,  60 => 3,  37 => 1,);
    }
                    ...
                    <div class=\"border_form\">
                        <div class=\"padding_eight_all bg-white\">
                            ...
                            <form method=\"post\" class=\"ng-untouched ng-pristine ng-invalid\">
                                ...
                                <div class=\"form-group mb-3\"><button type=\"submit\" name=\"login\"
                                        class=\"btn btn-fill-out btn-block\">{% trans %}Log in{% endtrans %}</button></div>
                                <ul class=\"btn-login list_none text-center\">
                                    <li><a href=\"{{path('fcb_login')}}\" class=\"btn btn-facebook\"><i class=\"ion-social-facebook\"></i>Facebook</a></li>
                                    <li><a href=\"{{path('connect_google')}}\" class=\"btn btn-google\"><i class=\"ion-social-google\"></i>Google</a></li>
                                </ul>
                                <a href=\"{{ path('app_forgot_password_request')}}\">{% trans %}Forgot password?{% endtrans %}</a>
                            </form>
                            <div class=\"different_login\"><span>
                                    {% trans %}or{% endtrans %}</span></div>
...
{% endblock %}
", "security/login.html.twig", "C:\\WEB_DEVELOPER\\AFAMIA\\AFAMIA_SHOP\\templates\\security\\login.html.twig");
    }
}
