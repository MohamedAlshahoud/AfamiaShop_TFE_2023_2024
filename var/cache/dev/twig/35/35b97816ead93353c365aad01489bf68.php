...
class __TwigTemplate_1e08c462b59104ced87328ab85efb4d5 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "emails/check_newsletters.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "emails/check_newsletters.html.twig"));
...
{% block title %}AfamiaShop | {% trans %}Newsletter subscription email sent{% endtrans %}{% endblock %}
        ...
        <div class=\"row justify-content-center\">
            <div class=\"col-xl-6 col-md-10\">
                <div class=\"border_form\">
                    <div class=\"padding_eight_all bg-white\">
                        <div class=\"heading_s1\">
                            <h3>{% trans %}Newsletter subscription{% endtrans %}</h3>
                        </div>
                        <div class=\"content\">
                            <p>
                                {% trans %}If there is an account matching your email address, an email has just been sent containing a link you can use to confirm your newsletter subscription .{% endtrans %}
                            </p>
                            <p>{% trans %}If you don't receive an email please check your spam folder or {% endtrans %}<a href=\"{{ path('app_newsletters')}}\"> {% trans %}try again{% endtrans %}</a></p>
                        </div>
                    </div>
                </div>
            </div>
...
{% endblock %}
", "emails/check_newsletters.html.twig", "/Users/modeste/Documents/Projets/Fiveer/AFAMIA_SHOP/templates/emails/check_newsletters.html.twig");
    }
}
