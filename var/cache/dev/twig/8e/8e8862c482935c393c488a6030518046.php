...
class __TwigTemplate_b176a6752a406bb7df3b6c8736163746 extends Template
{
    private $source;
    private $macros = [];
...
\t<div class=\"container\">
        ...
        yield " ";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 13, $this->source); })()), "reference", [], "any", false, false, false, 13), "html", null, true);
        yield " ";
...
";
    ...
    {
        return array (  114 => 16,  110 => 15,  101 => 13,  92 => 6,  82 => 5,  60 => 3,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("{% extends 'basePayment.html.twig' %}

{% block title %}AfamiaShop | {% trans %}Payment success{% endtrans %} {% endblock %}
...
\t<div class=\"container\">
        <div class=\"row justify-content-center\">
            <div class=\"col-md-8\">
                ...
                \t<i class=\"fas fa-check-circle\"></i>
                    <div class=\"heading_s1\">
                  \t<h3>{% trans %}Your order number {% endtrans %} {{ order.reference}} {% trans %}is completed!{% endtrans %}</h3>
                    </div>
                  \t<p>{% trans %}Thank you for your order!{% endtrans %}</p>
                    <a href=\"/\" class=\"btn btn-fill-out \">{% trans %}To the site AfamiaShop{% endtrans %}</a>
                </div>
            </div>
        </div>
    </div>
</div>
{% endblock %}", "payment/success.html.twig", "/Users/modeste/Documents/Projets/Fiveer/AFAMIA_SHOP/templates/payment/success.html.twig");
    }
}
