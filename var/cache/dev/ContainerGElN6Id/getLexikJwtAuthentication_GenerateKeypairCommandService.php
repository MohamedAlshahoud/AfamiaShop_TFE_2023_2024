...
class getLexikJwtAuthentication_GenerateKeypairCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['lexik_jwt_authentication.generate_keypair_command'] = $instance = new \Lexik\Bundle\JWTAuthenticationBundle\Command\GenerateKeyPairCommand(($container->privates['filesystem'] ?? ($container->privates['filesystem'] = new \Symfony\Component\Filesystem\Filesystem())), 'kernel.project_dir%/config/jwt/private.pem', 'kernel.project_dir%/config/jwt/public.pem', '97fb232e70502960fb9ef205bfb41f33bab6e676a08ff2edfae561e3fa5b8ea8', 'RS256');
