...
class __TwigTemplate_fe816fe9a9c33f21fa231529d17d5626 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div  class=\"top-header\" style=\"\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["locale"]) {
            ...
            yield "                            <div class=\"lng_dropdown mr-2\">
                                <a class=\"";
            // line 16
            if ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["app"] ?? null), "request", [], "any", false, false, false, 16), "locale", [], "any", false, false, false, 16) == $context["locale"])) {
                yield "active";
            }
            yield "\" href=\"";
            yield Twig\Extension\EscaperExtension::escape($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("change_locale", ["locale" => $context["locale"]]), "html", null, true);
            yield "\">";
    ...
    <div  class=\"bottom_header dark_skin main_menu_uppercase\">
        ...
        yield "</a></li>
                        ";
        // line 55
        if (CoreExtension::getAttribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, false, false, 55)) {
            // line 56
            yield "                            <li class=\"nav-item dropdown\">
                                <a class=\"nav-link dropdown-toggle href=\"#\" id=\"navbarDropdownMenuLink\" role=\"button\" data-bs-toggle=\"dropdown\" aria-expanded=\"false\">
                                ";
            // line 58
            yield Twig\Extension\EscaperExtension::escape($this->env, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, false, false, 58), "username", [], "any", false, false, false, 58), "html", null, true);
            yield "
                                </a>
        ...
        yield "</h3>
                                        ...
                                        <div class=\"box-collapse-wrap form\">
                                            <div class=\"row\">
                                                ";
        // line 88
        yield         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock(($context["search"] ?? null), 'form');
        yield "
                                            </div>
                                        </div>
                                    </div>
    ...
    {
        return array (  262 => 120,  227 => 88,  219 => 83,  210 => 76,  201 => 72,  195 => 71,  191 => 69,  189 => 68,  185 => 66,  176 => 62,  170 => 61,  164 => 58,  160 => 56,  158 => 55,  152 => 54,  145 => 52,  138 => 50,  135 => 49,  127 => 47,  125 => 46,  122 => 45,  114 => 43,  112 => 42,  107 => 40,  95 => 31,  81 => 20,  78 => 19,  63 => 16,  60 => 15,  56 => 14,  47 => 8,  38 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "header/index.html.twig", "C:\\WEB_DEVELOPER\\AFAMIA\\AFAMIA_SHOP\\templates\\header\\index.html.twig");
    }
}
